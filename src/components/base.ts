...
export const Button =
  "cursor-pointer py-1 px-2 bg-blue-500 rounded-lg text-white border border-blue-500 hover:bg-blue-600 focus:ring-2 focus:outline-none focus:ring-blue-300 disabled:cursor-auto disabled:bg-blue-300 disabled:border-blue-300 disabled:hover:bg-blue-300 disabled:text-gray-100";
